package br.com.thiago.tchat.dao.players.factory
    ...
    fun getConnection(pass: String?, user: String?, host: String, port: String, database: String): Connection? {
        ...
        try {
            ...
            try {
                ...
                Bukkit.getConsoleSender().sendMessage("§2[tChat] §cERROR CONNECTING TO DATABASE!")
            }
        } catch (ex: ClassNotFoundException) {
            Bukkit.getConsoleSender().sendMessage("§2[tChat] §cERROR CONNECTING TO DATABASE (DRIVER NOT FOUND)!")
        }
        return connection
    }
}