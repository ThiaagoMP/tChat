...
class WhisperCommand(
    ...
    fun sendMessage(
        ...
        val distance = config.getInt("Whisper.DistanceInBlocks")
        ...
        channelController.channels[channelType]!!.sendMessage(player, "&7[&aW&7] $message", players)
    }
}